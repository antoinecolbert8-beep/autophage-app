...
var daily_recap_cron_exports = {};
__export(daily_recap_cron_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(daily_recap_cron_exports);
...
var handler = schedule("0 18 * * *", async (event) => {
  console.log("\u23F0 Netlify Cron: Triggering Daily Recap Queue...");
  const siteUrl = process.env.URL || "http://localhost:3000";
  try {
    const response = await (0, import_node_fetch.default)(`${siteUrl}/api/cron/daily-recap`, {
      method: "GET",
      headers: {
