      ...
      <section className="py-32 px-6 bg-[#0f0f16]" id="features">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { title: "Productivité x5", desc: "Un seul agent accomplit le travail de 5 employés qualifiés.", color: "from-blue-500 to-cyan-500", icon: LineIconZap, visual: "⚡", illustration: "/assets/feat_productivity.png" },
      ...
      <section className="py-32 px-6 bg-[#0a0a0f]" id="pricing">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
            ...
            {/* GOD MODE (Lighter Background Fix) */}
            <div className="p-10 bg-pink-500/10 border border-pink-500/30 rounded-[2.5rem] flex flex-col hover:border-pink-500/60 transition-colors duration-500 group relative overflow-hidden shadow-[0_0_80px_rgba(236,72,153,0.1)]">
              ...
              <p className="text-sm text-gray-400 mb-8 min-h-[40px] relative z-10">Puissance illimitée pour écraser la concurrence.</p>
              <div className="space-y-4 mb-8 relative z-10">
                <div className="flex items-center gap-3 text-pink-200"><Zap className="w-5 h-5 text-pink-500" /> Agents Illimités</div>
                <div className="flex items-center gap-3 text-pink-200"><Zap className="w-5 h-5 text-pink-500" /> 15.000 Crédits/mois</div>
                <div className="flex items-center gap-3 text-pink-200"><Zap className="w-5 h-5 text-pink-500" /> LinkedIn Bot Pro</div>
                <div className="flex items-center gap-3 text-pink-200"><Zap className="w-5 h-5 text-pink-500" /> Dedicated Account Manager</div>
                <div className="flex items-center gap-3 text-pink-200"><Zap className="w-5 h-5 text-pink-500" /> Custom Branding</div>
                {/* NEW */}
                <div className="flex items-center gap-3 text-pink-200"><Zap className="w-5 h-5 text-pink-500" /> API Illimitée</div>
                <div className="flex items-center gap-3 text-pink-200"><Zap className="w-5 h-5 text-pink-500" /> Dashboard Analytics Avancé</div>
                <div className="flex items-center gap-3 text-pink-200"><Zap className="w-5 h-5 text-pink-500" /> SLA & Support 24/7</div>
                <div className="flex items-center gap-3 text-pink-200"><Zap className="w-5 h-5 text-pink-500" /> Audit IA Mensuel</div>
                <div className="flex items-center gap-3 text-pink-200"><Zap className="w-5 h-5 text-pink-500" /> Accès Code Option</div>
              </div>
              <button className="w-full py-4 border border-pink-500/50 text-pink-500 rounded-xl font-bold hover:bg-pink-500 hover:text-white transition-colors relative z-10">Contacter Sales</button>
            </div>
          </div>
        </div>
      </section>
