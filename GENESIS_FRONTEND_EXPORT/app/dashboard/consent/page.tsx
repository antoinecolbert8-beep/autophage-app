...
export default function ConsentPage() {
    const integrations = [
        ...
        { name: "LinkedIn Sales Nav", connected: true },
                    ...
                    {integrations.map((app, i) => (
                        <div key={i} className="flex items-center justify-between p-6 border-b border-white/5 last:border-0 hover:bg-white/5 transition-colors">
                            ...
                            {app.connected ? (
                                ...
                                <button className="px-4 py-2 border border-white/10 rounded-lg hover:bg-white/5 transition-colors text-gray-400 hover:text-white">
                                    Connecter
                                </button>
                            )}
                        </div>
